    ...
    <Box sx={{ position: 'relative', height: '100%' }} >        
      <Container sx={{ height: '100%' }}>
        <Box sx={{ ...sxSlide, zIndex: { xs: 'unset', sm: 999} }}>
          <Box sx={{ mx: 'auto', height: '100%', width: 'fit-content', py: 5, px: { xs: 2, sm: 8} }}>            
            <Grid container spacing={4} alignItems='center' justifyContent='center' >          
              <Grid item xs={12} md={4} order={{ xs: 3, sm: 1 }}>
                <Typography fontSize={21} sx={{ maxWidth: { xs: 'unset', md: '28ch'}, height: { xs: '10rem', sm: '5rem', md: 'unset' } }}>{slide.text}</Typography>
              </Grid>
